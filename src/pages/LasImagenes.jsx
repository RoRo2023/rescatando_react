    ...
    return(
        ...
        <HeaderComponent/>
            ...
            <section class="body container">
                ...
                <ul>
                    <li class="bold">Imágenes irrepetibles de hallazgos espeleológicos, arqueológicos y de accidentes geográficos remotos.</li>
                    <li class="bold">Fotografías icónicas de México: pueblos, fiestas, rituales, tradiciones y maravillas naturales.</li>
                    <li class="bold">Un tesoro con valor patrimonial para los mexicanos.</li>
                </ul>
                <h4 class="blue bold">ACERVO DE 100,000 IMÁGENES ICÓNICAS DE MÉXICO</h4>
                <h4 class="blue">en diapositivas tomadas por destacados fotógrafos.</h4>
